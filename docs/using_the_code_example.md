...
The following example clones the "[Smart I/O I2S controller](https://github.com/Infineon/mtb-example-psoc-edge-smartio-i2s)" application with the desired name "SmartioI2scontroller" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-smartio-i2s --user-app-name SmartioI2scontroller --target-dir "C:/mtb_projects"
   ```
